...
public class Prefs {
    ...
    // ADBye Protection tab â€” see firewall_blocking_tab.md
    ...
    public static final String PREF_DNS_PROVIDER_ID = "dns_provider_id";
    public static final String PREF_DNS_SERVER_ID = "dns_server_id";
    ...
    public static int getDnsProviderId(SharedPreferences p)     { return p.getInt(PREF_DNS_PROVIDER_ID, -1); }
    public static int getDnsServerId(SharedPreferences p)       { return p.getInt(PREF_DNS_SERVER_ID, -1); }
