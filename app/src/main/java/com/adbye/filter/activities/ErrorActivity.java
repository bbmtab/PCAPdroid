...
public final class ErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.adbye.filter.R.layout.error_activity);
        ...
        Button emailButton = ((Button)findViewById(com.adbye.filter.R.id.report_button));
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO);
        emailIntent.setData(Uri.parse("mailto:"));
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"Emanuele Faranda <black.silver@hotmail.it>"});
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "ADBye crash");
