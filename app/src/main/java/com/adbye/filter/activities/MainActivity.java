...
import com.adbye.filter.AppsResolver;
import com.adbye.filter.Billing;
import com.adbye.filter.BuildConfig;
import com.adbye.filter.CaptureHelper;
import com.adbye.filter.ConnectionsRegister;
import com.adbye.filter.Log;
import com.adbye.filter.MitmReceiver;
import com.adbye.filter.PCAPdroid;
import com.adbye.filter.VpnReconnectService;
import com.adbye.filter.activities.prefs.SettingsActivity;
import com.adbye.filter.fragments.DataViewContainerFragment;
import com.adbye.filter.fragments.StatusFragment;
import com.adbye.filter.interfaces.AppStateListener;
import com.adbye.filter.model.AppDescriptor;
import com.adbye.filter.model.AppStats;
import com.adbye.filter.model.AppState;
...
import com.adbye.filter.MitmAddon;
...
import com.adbye.filter.model.CaptureList;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void initPeerAppInfo() {
        if(!BuildConfig.APPLICATION_ID.equals("com.adbye.filter.debug"))
            return;

        final String peerAppPackage = "com.adbye.filter";
        ...
        intent.setClassName(peerAppPackage, "com.adbye.filter.activities.CaptureCtrl");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.item_apps) {
            ...
            String url = "https://play.google.com/store/apps/details?id=com.adbye.filter";
